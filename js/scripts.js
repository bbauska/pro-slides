        ...
        <footer class="footer">
          <small style="margin-bottom: 20px; display: inline-block">
            ...
            <span style="color: red; font-size: 18px">&#10084;</span> by -
              <a target="_blank" href="https://bbauska.netlify.app"> Brian Bauska </a>
          </small>
          <br />
          <div class="social-links">
            <a href="https://github.com/bbauska" target="_blank">
              <i class="ri-github-fill ri-xl"></i>
            </a>
            <a href="https://twitter.com/bbauska" target="_blank">
              <i class="ri-twitter-fill ri-xl"></i>
            </a>
            <a href="https://codepen.io/bbauska" target="_blank">
              <i class="ri-codepen-fill ri-xl"></i>
            </a>
            <a href="https://www.linkedin.com/in/brian_bauska/" target="_blank">
